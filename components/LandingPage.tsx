...
const LandingPage: React.FC<LandingPageProps> = ({ onStartPlanning, showAppInstallBanner = false }) => {
  return (
      ...
      <div className="relative z-10">
        <div className={`max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 pb-8 sm:pb-12 md:pb-16 transition-all duration-300 ease-out ${
          ...
          <div className="text-center">
            ...
            <div className="animate-slide-up" style={{ animationDelay: '0.4s' }}>
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-600 mb-4 sm:mb-6 md:mb-8 max-w-4xl mx-auto leading-relaxed px-3 sm:px-4">
            ...
            {/* Trust Indicators */}
            <div className="mt-6 sm:mt-8 md:mt-12 animate-fade-in" style={{ animationDelay: '0.8s' }}>
              <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4 md:gap-6 lg:gap-8 text-xs sm:text-sm text-slate-500 px-3 sm:px-4">
      ...
      <div className="py-8 sm:py-12 md:py-16 lg:py-20 bg-white/80 backdrop-blur-sm relative">
        <div className="absolute inset-0 bg-wave-pattern opacity-5"></div>
        <div className="relative z-10 max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
          <div className="text-center mb-8 sm:mb-12 md:mb-16 animate-fade-in">
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-slate-800 mb-3 sm:mb-4 md:mb-6 px-3 sm:px-4">
              ¿Por qué elegir{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-ocean-600 to-sea-600">
                BoatTrip Planner?
              </span>
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-slate-600 max-w-3xl mx-auto px-3 sm:px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            {/* Enhanced Feature 1 */}
            <div className="group text-center p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl bg-gradient-to-br from-ocean-50 to-ocean-100 border border-ocean-200 hover:border-ocean-300 transition-all duration-300 hover:shadow-medium transform hover:-translate-y-2 animate-fade-in" style={{ animationDelay: '0.2s' }}>
              <div className="relative mb-3 sm:mb-4 md:mb-6">
                <div className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 bg-gradient-to-br from-ocean-500 to-ocean-600 rounded-xl sm:rounded-2xl flex items-center justify-center mx-auto shadow-medium group-hover:shadow-glow transition-all duration-300">
                  <MapRouteIcon className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 text-white" />
                </div>
                <div className="absolute -inset-2 bg-gradient-to-r from-ocean-400 to-ocean-600 rounded-xl sm:rounded-2xl opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-300"></div>
              </div>
            ...
            {/* Enhanced Feature 2 */}
            <div className="group text-center p-6 sm:p-8 rounded-2xl bg-gradient-to-br from-sea-50 to-sea-100 border border-sea-200 hover:border-sea-300 transition-all duration-300 hover:shadow-medium transform hover:-translate-y-2 animate-fade-in" style={{ animationDelay: '0.4s' }}>
              <div className="relative mb-4 sm:mb-6">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-sea-500 to-sea-600 rounded-2xl flex items-center justify-center mx-auto shadow-medium group-hover:shadow-glow transition-all duration-300">
                  <ChecklistIcon className="w-8 h-8 sm:w-10 sm:h-10 text-white" />
                </div>
                <div className="absolute -inset-2 bg-gradient-to-r from-sea-400 to-sea-600 rounded-2xl opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-300"></div>
              </div>
            ...
            {/* Enhanced Feature 3 */}
            <div className="group text-center p-6 sm:p-8 rounded-2xl bg-gradient-to-br from-sunset-50 to-sunset-100 border border-sunset-200 hover:border-sunset-300 transition-all duration-300 hover:shadow-medium transform hover:-translate-y-2 animate-fade-in" style={{ animationDelay: '0.6s' }}>
              <div className="relative mb-4 sm:mb-6">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-sunset-500 to-sunset-600 rounded-2xl flex items-center justify-center mx-auto shadow-medium group-hover:shadow-glow transition-all duration-300">
                  <StarOutlineIcon className="w-8 h-8 sm:w-10 sm:h-10 text-white" />
                </div>
                <div className="absolute -inset-2 bg-gradient-to-r from-sunset-400 to-sunset-600 rounded-2xl opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-300"></div>
              </div>
              <h3 className="text-xl sm:text-2xl font-bold text-slate-800 mb-3 sm:mb-4">
      ...
      <div className="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-slate-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-800 mb-3 sm:mb-4 px-4">
              ¿Cómo funciona?
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center">
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-blue-500 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 text-white text-xl sm:text-2xl font-bold">
                1
              </div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-teal-500 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 text-white text-xl sm:text-2xl font-bold">
                2
              </div>
              <h3 className="text-lg sm:text-xl font-semibold text-slate-800 mb-2 sm:mb-3">
                IA Genera tu Plan
            ...
            <div className="text-center">
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-purple-500 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 text-white text-xl sm:text-2xl font-bold">
                3
              </div>
              <h3 className="text-lg sm:text-xl font-semibold text-slate-800 mb-2 sm:mb-3">
                ¡Disfruta tu Viaje!
      ...
      {/* CTA Section */}
      <div className="py-12 sm:py-16 md:py-20 bg-gradient-to-r from-blue-600 to-teal-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Button
            onClick={onStartPlanning}
            variant="secondary"
            className="text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 bg-white text-blue-600 hover:bg-blue-50 shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-200 w-full sm:w-auto max-w-sm sm:max-w-none"
          >
